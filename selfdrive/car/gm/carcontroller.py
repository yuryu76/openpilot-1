    ...
    def update(self, enabled, CS, frame, actuators,
        ...
        if CS.lka_steering_cmd_counter != self.lka_steering_cmd_counter_last:
            ...
            lkas_enabled = enabled and not (
                        CS.out.steerWarning or CS.out.steerError) and CS.out.vEgo > P.MIN_STEER_SPEED
            if lkas_enabled:
            ...
            can_sends.append(
                gmcan.create_steering_control(self.packer_pt, CanBus.POWERTRAIN, apply_steer, idx, lkas_enabled))
